...
def report(directory):
    ...
    return {"schema_version": 1, "kind": "isaac_ground_mission_summary", "backend": "isaacsim_physx",
        ...
        **{k: config[k] for k in ("model", "actuator", "mission", "physics_options", "dt_s", "duration_s")},
        ...
        "limitations": ["Calm air and perfect state", "Illustrative cuboid contact geometry and friction",
