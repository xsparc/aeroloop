...
export default function Scene({
  ...
  useEffect(() => {
    ...
    camera.position.set(3.3, 2.8, 3.8);
    ...
    aircraft.add(
      new THREE.Mesh(new THREE.BoxGeometry(0.55, 0.055, 0.055), material),
    );
    aircraft.add(
      new THREE.Mesh(new THREE.BoxGeometry(0.055, 0.55, 0.055), material),
    );
    for (const [x, y] of [
      [0.25, 0],
      [-0.25, 0],
