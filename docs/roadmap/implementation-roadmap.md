...
| AL-002 | Tested C++ rate core running in a CPU rigid-body model; hover, step and force pulse with measured outputs | Planned |
...
Complete AL-001 CPU checks, then AL-002 and AL-003 while the Isaac environment is
unavailable. Reassess the plan after each retained validation result. Do not create
