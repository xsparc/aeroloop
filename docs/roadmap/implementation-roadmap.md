...
| AL-011 | Fixed-cadence PhysX flight-controller study and read-only live 3D monitoring | In progress: nine measured missions and monitoring acceptance required |
